...
While a strong match in personalities and research interests is important, many students also consider the faculty's research achievements.  The general metrics are papers, citations, students (current and graduated), etc.  However, these metrics might not be accurate (e.g., in AI/ML, even students often have a lot of citations because the field is hot and many people cite their papers). 

Thus, you should look beyond these metrics and consider the quality of the work and their impact on the field, and the reputation and the ability to obtain funding from the faculty.  These are typically measured by prestigious awards and recognitions, which are often more important than the number of papers or citations and highlighted in their CV and even on the department or university website.
...
I am very happy to hear that you plan to write a short blurp about VuPhong and VuLam’s chess achievements.  I thought I would provide some additional context just in case it helps.  

This is a PWCS chess tournament for K-12 kids (http://chess.tylerlargen.com/).  It has been around for quite sometime, probably 10+ years.  While it is PWCS, it is opened for anyone and I’ve seen teams from various parts of NOVA, including Alexandria and Arlington.   

The tournament is categorized into groups including  K—3 ,  4-5,  middle schools, high schools.  Each kid will play 4 matches.  If you win, you get 1 point.  If you draw, each player has .5 point.  So 4 points is the perfect scores and indicate you won all matches.  3.5 points means you won 3 out of 4 games and draw 1.  If multiple kids have the same points, then the computer will randomly pick the order because trophies are numbered 1st, 2nd, 3rd, etc.   So if there are 2 kids with 4 pts, and 3 kids with 3.5 points, and 2 kids with 3 points, then the first 2 kids will be given 1st and 2nd place, the 3 kids with 3.5 points are given 3rd -- 5th place, and the 2 kids with 3 points are 6th and 7th.


For the last tournament on Feb 15,  both VuPhong (3rd grade) and VuLam (K) played in the K-3 group. They were the only two from Marshall.   VuLam won all of his matches and get perfect score.  There was another kid that also get the perfect score.  So the two of them are undefeated in their group and share first place but VuLam's trophy shows 2nd. 
VuPhong also did very well, winning 3 out of 4 matches and get 3 points and get 4th place.  So they both get trophies.  

I do not really understand how team scores are calculated though it seems like the sum of the scores are used.  


VuPhong also did very well, winning 3 out of 4 matches and get 3.5 points.  He was the only one with 3.5 points and thus got 3rd place.  So both of them got trophies.  I think this is the first time that Marshall has two kids in the top 3.  I am very proud of them.
