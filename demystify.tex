...
\section{The offer letters and terms}
...
This is essentially an employment contract, and you need to sign it to accept the offer.  

Read this carefully and make sure you understand it. 
Most relevant information is the stipend, tuition waiver, and health insurance. the letter might also indicate additional information such as the duration of the offer for TA or who you would be working with for RA, etc.  The letter might also have some conditions, e.g., maintaining a certain GPA, etc. It might also have a deadline for you to accept the offer, e.g., April 15.

\autoref{fig:gra-offer} shows an example of a GRA offer letter from Mason. It shows the 9-month stipend, tuition waiver, and health insurance.  It also states the prof. that offers the RA and other conditions (e.g., mtaining a 3.0 GPA and receiving satisfactory grades) which are relatively standard. 


\begin{figure}
    \begin{tabular}{c|c}
        \includegraphics[page=1,width=.65\textwidth]{files/gra_offer.pdf} & 
        \includegraphics[page=2,width=.65\textwidth]{files/gra_offer.pdf} 
    \end{tabular}
